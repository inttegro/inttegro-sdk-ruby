...
module Inttegro
  module OTP
    ...
    #   `{service}` placeholder. Email sends this as the plain-text fallback and renders the copy
    ...
    #
    # @!attribute [r] sender
    #   Optional SMS sender identifier (3-12 characters). Email OTP always uses
    #   noreply@inttegro.com; omit this field for email or supply exactly that address.
    #
