...
require_relative "updated_bank"
require_relative "updated_owner"
require_relative "updated_wallet"
...
module Inttegro
  class FinancialAccount
    ...
    #   @return [Inttegro::FinancialAccount::UpdatedBank, nil]
    #
    ...
    #   @return [Inttegro::FinancialAccount::UpdatedOwner, nil]
    #
    # @!attribute [r] wallet
    ...
    #   @return [Inttegro::FinancialAccount::UpdatedWallet, nil]
    class Updated < T::Struct
      ...
      const :bank_account, T.nilable(Inttegro::FinancialAccount::UpdatedBank), default: nil
      const :disconnected_at, T.nilable(Time), default: nil
      const :dosh_account, T.nilable(Inttegro::Shared::DoshAccount), default: nil
      const :owner, T.nilable(Inttegro::FinancialAccount::UpdatedOwner), default: nil
      const :wallet, T.nilable(Inttegro::FinancialAccount::UpdatedWallet), default: nil
    end
  end
end
