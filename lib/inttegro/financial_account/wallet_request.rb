...
require_relative "wallet_request_type"
require_relative "wallet_request_wallet"

module Inttegro
  class FinancialAccount
    # Typed representation of the wallet request object in the Inttegro API.
    #
    ...
    #   @return [Inttegro::FinancialAccount::OwnerInput]
    #
    ...
    #
    #   Required in the API payload. Wire name: `wallet`.
    #   @return [Inttegro::FinancialAccount::WalletRequestWallet]
    class WalletRequest < T::Struct
      const :currency, String
      const :custom_data, T.nilable(Inttegro::CustomDataInput), default: nil
      const :description, T.nilable(String), default: nil
      const :label, String
      const :owner, Inttegro::FinancialAccount::OwnerInput
      ...
      const :type, Inttegro::FinancialAccount::WalletRequestType
      const :wallet, Inttegro::FinancialAccount::WalletRequestWallet
    end
  end
end
