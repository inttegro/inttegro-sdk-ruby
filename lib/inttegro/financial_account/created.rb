...
require_relative "created_bank"
require_relative "created_owner"
...
module Inttegro
  class FinancialAccount
    ...
    #   @return [Inttegro::FinancialAccount::CreatedBank, nil]
    #
    # @!attribute [r] owner
    ...
    #   @return [Inttegro::FinancialAccount::CreatedOwner, nil]
    #
    # @!attribute [r] wallet
    ...
    class Created < T::Struct
      ...
      const :bank_account, T.nilable(Inttegro::FinancialAccount::CreatedBank), default: nil
      const :owner, T.nilable(Inttegro::FinancialAccount::CreatedOwner), default: nil
