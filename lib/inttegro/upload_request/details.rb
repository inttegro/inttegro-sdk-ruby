...
module Inttegro
  class UploadRequest
    ...
    #
    # @!attribute [r] attempt
    #   Value of the `attempt` field in the Inttegro API payload.
    #
    #   Optional in the API payload; omitted values default to `nil`. Wire name: `attempt`.
    #   @return [Inttegro::UploadRequest::Attempt, nil]
    class Details < T::Struct
      ...
      const :attempt, T.nilable(Inttegro::UploadRequest::Attempt), default: nil
    end
  end
end
